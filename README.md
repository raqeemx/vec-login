...
- **إعدادات Firebase في مكان واحد:** يتم تحميل التهيئة من ملف `firebase-config.js`، لذا لا حاجة لتكرار القيم في الصفحات. يكفي تحديث الملف مرة واحدة لكل البيئات.
- **وحدة main.js مستقلة:** الملف `main.js` يوفر نموذج تقييم محلي يعتمد على المتصفح و`localStorage` فقط، ولا يتصل بـ Firebase أو صفحات المصادقة/لوحة التحكم. استخدمه كأداة أوفلاين أو مرجع لوظائف التصدير والتحقق المتقدمة.
...
- [x] دعم رفع الصور إلى Firebase Storage
